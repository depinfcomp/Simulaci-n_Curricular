...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('student_subject', function (Blueprint $table) {
            ...
            $table->integer('effective_credits')->default(0)->after('subject_credits');
            ...
            // Valores: 'fundamental_required', 'professional_required', 'optional_fundamental', 'optional_professional', 'free_elective', 'thesis', 'practice', 'leveling', 'na'
